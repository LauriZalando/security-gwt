...
/**
 * Util to consolidate classpath manipulation stuff in one place. This is taken from gwt-maven-plugin
 *
 * @author            ccollins
 * @version           $Id$
 * @plexus.component  role="de.zalando.security.maven.plugin.ClasspathBuilder"
 */
public class ClasspathBuilder extends AbstractLogEnabled {
    ...
    public Collection<File> buildClasspathList(final MavenProject project, final String scope,
            final Set<Artifact> artifacts) throws Exception {
