 ...
 * String.hashCode().
 */
class SafeHtmlStringCopy implements SafeHtml {
    private String html;

    /**
     * Constructs a {@link SafeHtmlStringCopy} from a string. Callers are responsible for ensuring that the string passed as
     * the argument to this constructor satisfies the constraints of the contract imposed by the {@link SafeHtml}
     * interface.
     *
     * @param  html  the string to be wrapped as a {@link SafeHtml}
     */
    SafeHtmlStringCopy(final String html) {
        if (html == null) {
