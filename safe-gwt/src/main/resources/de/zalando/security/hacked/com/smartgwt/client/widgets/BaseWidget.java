/**
 * NOTE: These sources are copied from smartgwt 2.5 and slightly modified for our needs.
 */
/*
...
public abstract class BaseWidget extends Widget implements HasHandlers {
     ...
     */
    protected final <H extends EventHandler> HandlerRegistration doAddHandler(final H handler,
            final GwtEvent.Type<H> type) {
    ...
    protected BaseWidget(final JavaScriptObject jsObj) {
    ...
    public static BaseWidget getRef(final JavaScriptObject jsObj) {
     ...
     */
    public void setScClassName(final String scClassName) {
    ...
    public void setConfigOnly(final boolean configOnly) {
     ...
     *
     * <p><b>Note</b> : {@link Canvas#setRedrawOnResize} should be set to true for components whose inner HTML will not
    ...
    public void doOnRender(final Function function) {
        onRenderFn = function;
    }
    ...
    public Element getElement(final boolean allowPreRender) {
        ...
        if (!isElementSet) {
            ...
            // need to set properties before calling clear else the properties are not set on the jsObj (it ends up on
            // the config)
    ...
    public void setHtmlElement(final Element element) {
    ...
    public void setConfig(final JavaScriptObject config) {
        this.config = config;
    }
    ...
    protected String getAttribute(final String attribute) {
    ...
    private void error(final String attribute, final String value) throws IllegalStateException {
        error("Cannot change configuration property '" + attribute + "' to " + value
                + " after the component has been created.");
    }

    protected void errorIfNotCreated(final String property) throws IllegalStateException {
        if (!isCreated()) {
    ...
    protected void error(final String message) throws IllegalStateException {
        if (!GWT.isScript()) {
    ...
    protected void setAttribute(final String attribute, String value, final boolean allowPostCreate) {

        if (value != null) {
            final SafeHtml safeHtml = SimpleHtmlSanitizer.sanitizeHtml(value);
            value = safeHtml.asString();
        }
    ...
    protected void setAttribute(final String attribute, final ValueEnum value, final boolean allowPostCreate) {
        if (!isCreated()) {
    ...
    protected void setAttribute(final String attribute, final BaseWidget value, final boolean allowPostCreate) {
    ...
    protected void setAttribute(final String attribute, final Map value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, value);
        } else if (allowPostCreate) {
    ...
    protected void setAttribute(final String attribute, final int[] value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, value);
        } else if (allowPostCreate) {
    ...
    protected void setAttribute(final String attribute, final Float[] value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, value);
        } else if (allowPostCreate) {
            setProperty(attribute, JSOHelper.convertToJavaScriptArray(value));
    ...
    protected void setAttribute(final String attribute, final DataClass value, final boolean allowPostCreate) {
    ...
    protected void setAttribute(final String attribute, final JavaScriptObject[] value, final boolean allowPostCreate) {
    ...
    protected void setAttribute(final String attribute, final BaseClass[] value, final boolean allowPostCreate) {
    ...
    protected void setAttribute(final String attribute, final double value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, value);
        } else if (allowPostCreate) {
            setProperty(attribute, value);
    ...
    protected void setAttribute(final String attribute, final Integer value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, value);
        } else if (allowPostCreate) {
            if (value == null) {
    ...
    protected void setAttribute(final String attribute, final Date value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, value);
        } else if (allowPostCreate) {
            if (value == null) {
    ...
    protected void setAttribute(final String attribute, final String[] value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, JSOHelper.convertToJavaScriptArray(value));
        } else if (allowPostCreate) {
            setProperty(attribute, JSOHelper.convertToJavaScriptArray(value));
    ...
    protected void setAttribute(final String attribute, final Object[] value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, JSOHelper.convertToJavaScriptArray(value));
        } else if (allowPostCreate) {
            setProperty(attribute, JSOHelper.convertToJavaScriptArray(value));
    ...
    protected void setAttribute(final String attribute, final Boolean value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, value);
        } else if (allowPostCreate) {
            if (value == null) {
    ...
    protected void setAttribute(final String attribute, final Element value, final boolean allowPostCreate) {
        if (!isCreated()) {
            JSOHelper.setAttribute(config, attribute, value);
        } else if (allowPostCreate) {
            setProperty(attribute, value);
